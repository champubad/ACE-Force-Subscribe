    ...
    if update_channel:
        try:
	        ...
	        reply_markup=InlineKeyboardMarkup(
                    [
                        [
                           InlineKeyboardButton("Join Updates Channel", url="https://t.me/SigmaMirrorz"),
                           InlineKeyboardButton("Support Group", url="https://t.me/Sigma_Off_Topic")
                      ],
                     [
                           InlineKeyboardButton("🧑‍💻Devloper🧑‍💻", url="https://t.me/Hamzawayne")
                     ]
                 ]
             ),
        parse_mode="markdown",
...
async def _source_code(client, message):
	...
	reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🌐 Source Code 🌐", url="https://t.me/SigmaMirrorz")
                ],
                [
                    InlineKeyboardButton("🌟 Join Channel", url="https://t.me/SigmaMirrorz"),
                    InlineKeyboardButton("💬 Support Group", url="https://t.me/Sigma_Off_Topic")
                ],
                [
                    InlineKeyboardButton("👨‍💻 Developer 🧑‍💻", url="https://t.me/Hamzawayne")
                ]
            ]
        ),
        parse_mode="markdown",
    ...
    if update_channel:
        try:
            ...
            if user.status == "kicked":
               await client.send_message(
                   chat_id=message.chat.id,
                   text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Sigma_Off_Topic).",
                   parse_mode="markdown",
                   disable_web_page_preview=True
               )
               return
            ...
            await client.send_message(
                chat_id=message.chat.id,
                text="Hey use this command in my pm. \nFor more help ask in my [Support Group](https://t.me/Sigma_Off_Topic).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
